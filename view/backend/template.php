    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li <?php if (stripos($_SERVER['REQUEST_URI'],'index.php?action=commentsModeration') !== false) {echo 'class="active"';}
                elseif (stripos($_SERVER['REQUEST_URI'],'index.php?action=commentsByDate') !== false) {echo 'class="active"';}
                elseif (stripos($_SERVER['REQUEST_URI'],'index.php?action=commentsByPost') !== false) {echo 'class="active"';} ?>><a href="index.php?action=commentsModeration">Modérer les commentaires</a></li>
            </ul>
